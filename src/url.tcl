...
proc ::bonaPRE::urlADDEXEC { args } {
	...
	if { [getuser ${UAE_Nick} XTRA uauth] == 1 } {
		...
		set UAE_LOGERR 	[format "uAUTH * %s n'est pas iDENTiFiER au EGGDROP..." ${UAE_Nick}]
		set UAE_MSGERR	[format "uAUTH * Tes pas iDENTiFiER au EGGDROP... CouCOU!!"]
  		putquick "privmsg ${UAE_Chan} ${UAE_MSGERR}"
  		return -code error ${UAE_LOGERR};
	}
}
