if { [catch { package require bonaPRE-CONF-PUBLiC 1.1 }] } { die "${::bonaPRE::VAR(release)} modTCL * le fichier configuration.tcl doit être charger avant mysql_nossl.tcl" ; return }
